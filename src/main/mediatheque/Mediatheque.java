package main.mediatheque;

import java.io.*;
import java.util.*;

import main.mediatheque.client.*;
import main.mediatheque.document.*;
import main.util.*;

/**
 * La classe <code>Mediatheque</code> gere l'interface du systeme de
 * gestion de la main.mediatheque. Les principales fonctions sont :
 * <ul>
...
public final class Mediatheque implements Serializable {
        ...
        /**
         * Nom de la main.mediatheque, format libre.
         */
        private String nom;
        /** Objets geres par la main.mediatheque : Genre, Localisation, Client
        ...
        public void ajouterDocument(Document doc) throws OperationImpossible {
                ...
                if (lesDocuments.containsKey(doc.getCode())) {
                        ...
                        if(!g){
                                throw new OperationImpossible("Ajout d'un document avec un genre non inclus dans la main.mediatheque");
                        }
         ...
         * de la main.mediatheque donne par son code suppose unique.
         * L'exception <TT>OperationImpossible</TT> est levee si le document
         * est emprunte ou si le document n'appartient pas a la main.mediatheque.
        ...
        /**
         * Inscription d'un client dans la main.mediatheque. L'exception
         * <TT>OperationImpossible</TT> est levee si le client existe
         * deja dans la main.mediatheque ou si la categorie du client n'existe pas ou
         ...
         * de la main.mediatheque. L'exception <TT>OperationImpossible</TT> est levee
         * si le client n'appartient pas a la main.mediatheque ou s'il n'a pas
        ...
        public void afficherStatistiques() {
                if(debug)
                        System.out.println("Statistiques globales de la main.mediatheque \""
                                        + nom +"\" :");
        ...
        public boolean initFromFile() {
                ...
                try {
                        ...
                        System.out.println("Error reading main.mediatheque data");
                } catch (ClassNotFoundException cnfe) {
                        System.out.println(cnfe);
                        System.out.println("Error finding main.mediatheque class");
                }
                return true;
        }
        ...
        public final boolean saveToFile() {
                ...
                try {
                        ...
                        System.out.println(ioe);
                        System.out.println("Error writing main.mediatheque data");
                        return false;
                }
                return true;
        }
